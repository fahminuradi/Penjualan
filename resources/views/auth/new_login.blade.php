...
<html lang="en">
<head>
	<title>Penjualan App | Login</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="{{ asset('login_template/images/brand.png')}}" alt="IMG">
				</div>
				...
				<form action="{{route('login')}}" method="post" class="login100-form validate-form">
					...
					@csrf
					<div class="wrap-input100 validate-input" data-validate = "Mohon Lengkapi Username">
					...
					<div class="wrap-input100 validate-input" data-validate = "Mohon Lengkapi Password">
					...
					<div class="text-center p-t-12">
						...
						<a class="txt2" href="login_template/#">
							Username / Password?
						</a>
					</div>
